...
const PaymentForm = () => {
    ...
    const calculateChecksum = (payloadBase64: string) => {
        const stringToHash = payloadBase64 + '/pg/v1/pay' + pgConfig.saltKey ;
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        const data = {
            ...
            callbackUrl: "https://www.thecraftly.shop",
        ...
        try {
            ...
            if (response.data.success) {
                ...
                // If payment is initiated successfully, redirect the user
                setRedirectUrl(response.data.data.instrumentResponse.redirectInfo.url);
